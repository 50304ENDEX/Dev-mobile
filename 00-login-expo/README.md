...
"plugins": [
    [
        "react-native-auth0",
        {
            "domain": "dev-z86nqh0okt5tr0ja.us.auth0.com"
...
Replace `dev-z86nqh0okt5tr0ja.us.auth0.com` with your Auth0 domain value. If you have `samples.auth0.com` as your Auth0 domain you would have a configuration like the following:
